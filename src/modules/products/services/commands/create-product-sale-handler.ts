...
export default class CreateProductSalerHandler {
  ...
  async handler(data: CreateProductSaleInput): Promise<ProductSale> {
    ...
    data.from_zero_to_four_hundred_ninety_nine =
      price_base * (ProfileConsulter.FromZeroToFourHundredNinetyNine / 100)
    data.from_five_hundred_to_nine_hundred_ninety_nine =
      price_base *
      (ProfileConsulter.FromFiveHundredToNineHundredNinetyNine / 100)
    data.from_one_thousand_to_three_thousand_nine_hundred_ninety_nine =
      price_base *
      (ProfileConsulter.FromOneThousandToThreeThousandNineHundredNinetyNine /
        100)
    data.more_than_four_thousand =
      price_base * (ProfileConsulter.MoreThanFourThousand / 100)
